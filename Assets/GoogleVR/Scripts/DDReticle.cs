...
public class DDReticle : GvrBasePointer
{
    ...
    public override void OnPointerClickDown()
    {
        ExecuteEvents.Execute(gazedAt, null,
            (DragDropHandler handler, BaseEventData data) => handler.HandleGazeTriggerStart());
    }
    ...
    {
        ExecuteEvents.Execute(gazedAt, null,
            (DragDropHandler handler, BaseEventData data) => handler.HandleGazeTriggerEnd());
    }
